                        ...
                        while (flag) {
                            ...
                            if (sign == 1) {
                                ...
                                if (op == '+') res = a.add(b);
                                    ...
                                    res = a.divide(b, 8, RoundingMode.DOWN);
                                } else if (op == '^') {
    ...
    public String StrCompute(String exp) {
        ...
        if (deca.result != null) {
            ...
            if (deca.result.compareTo(biggestView) == 1 || deca.result.compareTo(smallestView) == -1 || (deca.result.compareTo(toPosi0View) == -1 && deca.result.compareTo(toNega0View) == 1)) {
                ...
                stra = deca.result.setScale(8, RoundingMode.DOWN).stripTrailingZeros().toPlainString();
            }
            ...
            stra = deca.errInfo;
            if (stra.equals("UNKE")) stra = "Unknown Error";
            else if (stra.equals("DIV0")) stra = "Divide by 0";
            else if (stra.equals("DOME")) stra = "Domain Error";
            else stra = "Syntax Error";
        }
        return stra;
    }
